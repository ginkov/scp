...
<div class="padding-md">
	<div class="panel panel-default">
		<div class="panel-heading" style="font-size:14px; height:52px;">
			<a href="<c:url value="/sale/usertype/list"/>" class="glink">优惠类型</a> / 详情 <span id="pPhynetMsg"></span>
			<sec:authorize access="hasAnyRole('ADMIN','SUPER')">
				<a class="btn btn-default btn-sm pull-right" href="<c:url value="/sale/usertype/edit/${ut.id}"/>" style="width:100px;"><i class="fa fa-pencil"></i> 编辑</a>
		...
		<div class="panel-body form-horizontal">
			<div class="form-group">
				<label class="col-md-2 control-label" for="name">营销类型</label>
				<div class="col-md-9">
					<input id="name" class="form-control" value="${ut.name}" readonly/>
				</div>
			</div>
			<div class="form-group">
				<label class="col-md-2 control-label" for="description">描述</label>
				<div class="col-md-9">
					<input id="description" class="form-control" value="${ut.description}" readonly />
				</div>
			</div>
	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-footer">
        		...
        		<a type="button" class="btn btn-sm btn-danger" href="<c:url value="/sale/usertype/del/${ut.id}" />">删除</a>
			</div>
		</div>
	</div>
</div>
