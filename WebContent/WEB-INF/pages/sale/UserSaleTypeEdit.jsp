...
<div class="padding-md">
	<div class="panel panel-default">
			<form:form commandName="userSaleType" cssClass="form-horizontal" action="${pageContext.request.contextPath}/sale/usertype/update" method="post" acceptCharset='utf-8'>
			<div class="panel-heading" style="font-size:14px; height:52px;">
				<a href="<c:url value="/sale/usertype/list"/>" class="glink">优惠类型</a> / 编辑<span id="pPhynetMsg"></span>
				<input class="btn btn-success btn-sm pull-right" style="width: 100px;" type="submit" value="修改"/>
			</div>
			<div class="panel-body">
				<form:input path="id" type="hidden"/>
				<div class="form-group">
					<label class="col-md-3 control-label" for="name">用户优惠类型</label>
					<div class="col-md-7">
