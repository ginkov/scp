...
<div class="padding-md">
	<div class="panel panel-default">
			<form:form commandName="t1" cssClass="form-horizontal" action="${pageContext.request.contextPath}/finance/exptype/update" method="post" acceptCharset='utf-8'>
			<div class="panel-heading" style="font-size:14px; height:52px;">
				<a href="<c:url value="/finance/exptype/list"/>" class='glink'>支出类别</a> / 修改 <span id="pPhynetMsg"></span>
				<input class="btn btn-success btn-sm pull-right" style="width: 100px;" type="submit" value="保存"/>
				<a class="btn btn-danger btn-sm pull-right" style="margin-right: 10px; width: 60px;" href="<c:url value="/finance/exptype/del/${t1.id}"/>"><i class="fa fa-trash"></i> 删除</a>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<label class="col-md-3 control-label" for="name">支出类别名</label>
					<div class="col-md-7">
