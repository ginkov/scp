...
<div style="display:none;" id="part_summary_helper" data-partsummary='${partSummary}'> </div>
<div style="display:none;" id="part_item_number_helper" data-partnumber='${fn:length(combo.partslist)}'> </div>

<div class="padding-md">
	<c:url value="/product/combo/input" var="inputUrl" />
	<form:form modelAttribute="combo" name="comboForm" cssClass="form-horizontal" action="${pageContext.request.contextPath}/product/combo/save" method="post" acceptCharset='utf-8'>
	<div class="panel panel-default">
			<div class="panel-heading" style="font-size:14px; height:52px;">
				<span><a href="<c:url value="/product/combo/list"/>" class='glink'>产品套装</a> / 添加</span>
				<input id="btnSumbit" class="btn btn-success btn-sm pull-right" style="width: 100px;" type="submit" value="保存" disabled/>
			</div>
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						...
						<form:input type="number" min="0" step="0.01" id="price" cssClass="form-control" path="listprice" required="true"/>
						</div>
					</div>
				</div>
				<!-- 上线/下线时间 -->
			...
			<div class="panel-footer">
				<div style="padding-bottom: 15px; margin-bottom: 25px; border-bottom: 1px #eee solid;">
					...
					<input style="width:100px;" class="btn btn-default btn-xs pull-right" type="button" value="添加/更新"
						onclick="document.comboForm.action='${inputUrl}'; document.comboForm.submit();"/>
				</div>
				<div class="form-group">
...
var ps = $('#part_summary_helper').data('partsummary');
