...
<div class="padding-md">
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="<c:url value="/product/part/list"/>" style="font-size: 18px;" class="glink">产品部件 /</a> 
        ...
        <div class="panel-body">
			<form class="form-inline" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/product/part_upload/do">
