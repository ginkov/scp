...
<div class="padding-md">
	<div class="panel panel-default">
		<div class="panel-heading">
			<a href="<c:url value="/product/combo/list"/>" style="font-size: 18px;" class="glink">产品套装 /</a> 
			<span style="font-size:14px; padding-left:10px;"> 通过 <a href="static/html/help/snippet/link-upload-format.html" class="glink" target='_blank'>EXCEL</a>文件批量上传</span>
		</div>
        <div class="panel-body">
			<form class="form-inline" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/product/combo_upload/do">
